package br.com.example.productcatalogservice.handler;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity handlerMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        ErroResponse erro = ErroResponse.builder()
                ...
                .erros(extrairDetalhesDeValidacao(ex))
                .build();

        return new ResponseEntity(erro, HttpStatus.BAD_REQUEST);
    }

    private List<ErroResponse.ErroDetalheResponse> extrairDetalhesDeValidacao(MethodArgumentNotValidException ex) {
